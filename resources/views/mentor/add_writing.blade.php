...
<!-- Start Class Card -->
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tambah Materi Writing Class</h1>
                    </div>
                        <form action="/mentor/writing" method="POST" enctype="multipart/form-data">
                            @csrf
                                          <div class="form-row">
        ...
        <option>Learning Reading</option>
        <option>Journal Deskriptif</option>
        <option>Journal Persuasif</option>
        <option>Essay</option>
        <option>Story Line</option>
      </select>
                                        </div>
                                        <div class="form-group">

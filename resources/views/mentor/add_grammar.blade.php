...
<!-- Start Class Card -->
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tambah Materi Grammar Class</h1>
                    </div>
                        <form action="/mentor/grammar" method="POST" enctype="multipart/form-data">
                            @csrf
                                          <div class="form-row">
        ...
        <option>Possive Voice</option>
        <option>Eliptical</option>
      </select>
                                        </div>
                                    <div class="form-group">

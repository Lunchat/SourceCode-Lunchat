                   ...
                   <div class="singel-event-list mt-30">
                       ...
                       <div class="event-cont">
                           <span><i class="fa fa-calendar"></i> 2 December 2018</span>
                            <a href="events-singel.html"><h4>Build Your Startup and You</h4></a>
                            <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                            <span><i class="fas fa-video"></i> Zoom Meeting</span>
                            <span><i class="fas fa-certificate"></i> Free E-Certificate</span>
                            <p>Webinar ini diselenggarakan oleh Lunchat dan ARS University.</p>
                            <a href="{{ url('/events_detail') }}" class="btn btn-warning">Detail</a>
                       </div>
                   </div>
               </div>
               <!-- <div class="col-lg-6">

...
<head>
    ...
    <title>Mentor Dashboard - LunChat</title>
    <!-- General CSS Files -->
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                     <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        <img alt="image" style="margin-bottom:4px !important;" src="{{ Auth::guard('mentor')->user()->getProfil() }}" class="rounded-circle mr-1 my-auto border-white">
                            

                                    {{ Auth::guard('mentor')->user()->name  }} <span class="caret"></span>
                                </a>

                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="{{ url('mentor/profil') }}" class="dropdown-item has-icon text-primary">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="{{ url('/mentor') }}" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-blue text-center"><i style="font-size: 30px;"></i><img src="{{ asset('assets/img/logolunchat2.png') }}"></a>
                        </div>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            <a href="{{ url('/mentor') }}" class="nav-link"><i class="fas fa-desktop"></i><span>Dashboard</span></a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('mentor/profil') }}">Profil</a></li>
                                <li><a class="nav-link" href="{{ url('mentor/data_mentor') }}">Data Mentor</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-header">Management Material</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                <span>Materials</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('mentor/data_materi') }}">Materials Data</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('mentor/tambah_materi') }}">Sharing Session</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/add_grammar') }}">Grammar Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/add_writing') }}">Writing Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/add_speaking') }}">Speaking Class</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-user"></i>
                                <span>Student</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('mentor/data_student') }}">Data Student</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard"></i>
                                <span>Room</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('mentor/room') }}">Sharing Session</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/grammar') }}">Grammar Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/writing') }}">Writing Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('mentor/speaking') }}">Speaking Class</a>
                                </li>
                            </ul>
                        </li>
                </aside>

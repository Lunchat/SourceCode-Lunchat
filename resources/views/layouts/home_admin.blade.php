...
<head>
    ...
    <title>Admin Dashboard - LunChat</title>
    <!-- General CSS Files -->
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                     <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" style="margin-bottom:4px !important;" src="{{ asset('img/default.png') }}" class="rounded-circle mr-1 my-auto border-white">

                                    Admin <span class="caret"></span>
                                </a>

                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="{{ url('admin/profil') }}" class="dropdown-item has-icon text-primary">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="{{ url('/admin') }}" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-blue text-center"><i style="font-size: 30px;"></i><img src="{{ asset('assets/img/logolunchat2.png') }}"></a>
                        </div>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('admin/data_student') }}">Data Student</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
                                <span>Mentor</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('admin/data_mentor') }}">Data Mentor</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                <span>Materi</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('admin/data_materi') }}">Data Materi</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('admin/tambah_materi') }}">Tambah Materi</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard"></i>
                                <span>Room</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ url('admin/room') }}">Sharing Session</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('admin/grammar') }}">Grammar Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('admin/writing') }}">Writing Class</a>
                                </li>
                                <li><a class="nav-link" href="{{ url('admin/speaking') }}">Speaking Class</a>
                                </li>
                            </ul>
                        </li>
                </aside>

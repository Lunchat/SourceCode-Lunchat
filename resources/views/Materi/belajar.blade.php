                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700">Lunchat Mentor</h3>
                        ...
                        <p class="font-weight-bold mt--5">
                            {{ $material->topik }}
                                ...
                                <a href='https://calendar.google.com/calendar/r/eventedit?text=&amp;dates={{ $material->tanggal }}T{{ $material->jam_mulai }}, {{ $material->tanggal }}, T{{ $material->jam_selesai }}&amp;ctz=Asia/Jakarta&amp;details={{ $material->topik }}."<br><br> URL Video :.{{ $material->topik }}&amp;location=Location&amp;pli=1&amp;uid=1521339627addtocalendar&amp;sf=true&amp;output=xml'
